...
import type commonCatalog from "./locales/az/common.json";
 ...
 * `User.locale`-dan götürür. `admin` kataloqu ictimai `MESSAGE_NAMESPACES` siyahısına
 * salınmır; ortaq UI komponentləri üçün lazım olan `common` isə burada ayrıca yüklənir.
 */
export const ADMIN_MESSAGE_NAMESPACES = ["admin", "common"] as const;
...
export type AdminMessages = {
  admin: typeof adminCatalog;
  common: typeof commonCatalog;
};
