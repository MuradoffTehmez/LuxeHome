  ...
  return (
    <ToastContext.Provider value={value}>
      ...
      <div
        aria-live="polite"
        aria-atomic="false"
        className="pointer-events-none fixed inset-x-4 bottom-[calc(1rem+var(--safe-bottom))] z-[100] flex flex-col items-center gap-2 sm:inset-x-auto sm:right-6 sm:bottom-[calc(1.5rem+var(--safe-bottom))] sm:items-end"
      >
        {toasts.map((item) => (
          <div
            key={item.id}
