...
const flat = [
  { id: "s-mastaga", name: "Maştağa", slug: "baki-mastaga", kind: "SETTLEMENT", parentId: "d-sabuncu" },
  { id: "d-sabuncu", name: "Sabunçu", slug: "baki-sabuncu", kind: "DISTRICT", parentId: "c-baku" },
  { id: "s-xirdalan", name: "Xırdalan", slug: "abseron-xirdalan", kind: "SETTLEMENT", parentId: "c-abs" },
  { id: "n-8km", name: "8-ci kilometr", slug: "baki-8-ci-kilometr", kind: "NEIGHBORHOOD", parentId: "d-nizami" },
  { id: "d-nizami", name: "Nizami", slug: "baki-nizami", kind: "DISTRICT", parentId: "c-baku" },
  { id: "v-novxani", name: "Novxanı", slug: "abseron-novxani", kind: "VILLAGE", parentId: "c-abs" },
  { id: "s-buzovna", name: "Buzovna", slug: "baki-buzovna", kind: "SETTLEMENT", parentId: "d-xezer" },
  { id: "d-xezer", name: "Xəzər", slug: "baki-xezer", kind: "DISTRICT", parentId: "c-baku" },
  { id: "s-bilgah", name: "Bilgəh", slug: "baki-bilgeh", kind: "SETTLEMENT", parentId: "d-sabuncu" },
];
...
describe("buildCityFilterTree()", () => {
  ...
  it("Bakının qəsəbələrini inzibati rayonun altında üçüncü səviyyə kimi verir", () => {
    ...
    expect(sabuncu?.children[0]).toEqual({ name: "Maştağa", slug: "baki-mastaga", kind: "SETTLEMENT" });
  });
  ...
  it("birinci səviyyəni əvvəlcə kind, sonra order üzrə düzür", () => {
    ...
    expect(abs).toEqual(["SETTLEMENT:abseron-xirdalan", "VILLAGE:abseron-novxani"]);
