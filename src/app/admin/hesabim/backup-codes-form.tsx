...
export function BackupCodesForm() {
  ...
  return (
    <form action={action} className="mt-4 flex max-w-xl flex-col gap-3">
      ...
      {state.secret ? <SecretPanel secret={state.secret} title="2FA ehtiyat kodları — bir dəfə göstərilir" note="Hər kod yalnız bir dəfə işləyir. Kodları parol menecerində və ya təhlükəsiz oflayn yerdə saxlayın." /> : null}
      <label className="text-sm text-ink-soft">
        Təhlükəsizlik üçün cari parol
