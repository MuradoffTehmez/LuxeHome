  ...
  return (
    <label className="sr-only">
      ...
      <span className="not-sr-only inline-flex items-center gap-2">
        ...
        disabled={pending}
        className="not-sr-only min-h-11 max-w-44 cursor-pointer rounded-sm border border-line-strong bg-paper px-2.5 text-sm text-ink outline-none transition-colors focus:border-gold disabled:cursor-wait disabled:opacity-60"
