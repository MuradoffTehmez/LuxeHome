...
export default async function SeoLandingsAdminPage({ searchParams }: Props) {
  ...
  return <>
    ...
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_460px]">
      <AdminForm action={saveSeoLanding} submitLabel={current ? "Landing-i yenilə" : "Landing yarat"} cancelHref={current ? "/admin/serp/landingler" : undefined}><FormSection title={t("pages.serp.landingMelumati")} description={t("pages.serp.filtersjsonPublicPropertyQuery")}>
