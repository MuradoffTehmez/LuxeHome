...
export default async function KeywordAdminPage() {
  ...
  <div className="grid grid-cols-1 gap-6 xl:grid-cols-[420px_minmax(0,1fr)]"><AdminForm action={saveSeoKeyword} submitLabel={t("pages.serp.keywordSaxla")}><FormSection title={t("pages.serp.keyword")}>
