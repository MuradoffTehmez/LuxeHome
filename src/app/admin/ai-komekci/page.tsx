...
import { analyzePropertyPhotos, applyDescriptionDraft, generatePropertyDescription } from "./actions";
...
export default async function AiAssistantPage() {
  ...
  return <>
    <AdminPageHeader title="AI köməkçi" description="Faktlara əsaslanan mətn qaralaması və foto keyfiyyəti məsləhətləri. Heç bir mətn insan təsdiqi olmadan dərc edilmir." breadcrumbs={[{ label: "İdarə paneli", href: "/admin" }, { label: "AI köməkçi" }]} />
