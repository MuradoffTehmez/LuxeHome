...
export default async function AiAssistantPage() {
  ...
  return <>
    <AdminPageHeader title={t("pages.ops.aiKomekci")} description={`Faktlara əsaslanan mətn qaralaması və foto keyfiyyəti məsləhətləri. Heç bir mətn insan təsdiqi olmadan dərc edilmir. Provayder: ${aiProviderLabel()}`} breadcrumbs={[{ label: t("pages.ops.idarePaneli"), href: "/admin" }, { label: t("pages.ops.aiKomekci") }]} />
