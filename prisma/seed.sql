...
-- Service (11)
INSERT OR IGNORE INTO "Service" ("id", "title", "slug", "shortDescription", "description", "icon", "imageUrl", "bullets", "order", "isActive", "metaTitle", "metaDescription", "createdAt", "updatedAt") VALUES ('cmt1srtp2002nuadwtsuo42hj', 'Alqı-Satqı', 'alqi-satqi', 'Bakıda daşınmaz əmlak alqı-satqısı: qiymətləndirmə, sənəd yoxlanışı, danışıqlar və notarial rəsmiləşdirmə üzrə peşəkar müşayiət.', 'Luxe Home Estate daşınmaz əmlakın alqı-satqısı prosesini əvvəldən sona qədər müşayiət edir. Əmlakın bazar dəyərinin qiymətləndirilməsindən başlayaraq, uyğun alıcı və ya satıcının tapılması, danışıqların aparılması, sənədlərin yoxlanılması və notarial rəsmiləşdirməyə qədər bütün mərhələlərdə yanınızdayıq.

Hər bir əmlak üzrə hüquqi təmizlik yoxlanılır, sənəd vəziyyəti dəqiqləşdirilir və tərəflər arasında şəffaf razılaşma təmin edilir.', 'Handshake', 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=1400&q=80', '["Əmlakın bazar dəyərinin qiymətləndirilməsi","Hüquqi sənədlərin yoxlanılması","Alıcı və satıcı arasında danışıqların aparılması","Notarial rəsmiləşdirmənin təşkili","Əməliyyat sonrası dəstək"]', 0, 1, 'Alqı-Satqı — Luxe Home Estate', 'Daşınmaz əmlakın alqı-satqısı üzrə peşəkar xidmət.', '2026-08-20T17:31:31.478Z', '2026-08-20T17:31:31.478Z');
...
INSERT OR IGNORE INTO "Service" ("id", "title", "slug", "shortDescription", "description", "icon", "imageUrl", "bullets", "order", "isActive", "metaTitle", "metaDescription", "createdAt", "updatedAt") VALUES ('cmt1srtpu002puadwe72925h2', 'İpoteka', 'ipoteka', 'İpoteka ilə mənzil alışı üçün uyğun əmlak seçimi, sənədlərin hazırlanması, qiymətləndirmə və bank tələbləri üzrə peşəkar dəstək.', 'İpoteka ilə mənzil almaq istəyən müştərilərə prosesin başa düşülməsində və sənədlərin hazırlanmasında kömək edirik. Hansı əmlakların ipoteka şərtlərinə uyğun olduğunu müəyyənləşdirir, bank tələblərinə uyğun sənəd paketinin toplanmasında yönləndiririk.

Qeyd: kredit qərarı və şərtləri müvafiq maliyyə qurumu tərəfindən müəyyən edilir.', 'Landmark', 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=1400&q=80', '["İpotekaya uyğun əmlakların seçimi","Sənəd paketinin hazırlanmasında dəstək","Bank tələbləri üzrə məsləhət","Əmlakın qiymətləndirilməsinin təşkili","Rəsmiləşdirmə mərhələsində müşayiət"]', 2, 1, 'İpoteka — Luxe Home Estate', 'İpoteka yolu ilə əmlak əldə etmək üçün dəstək.', '2026-08-20T17:31:31.507Z', '2026-08-20T17:31:31.507Z');
INSERT OR IGNORE INTO "Service" ("id", "title", "slug", "shortDescription", "description", "icon", "imageUrl", "bullets", "order", "isActive", "metaTitle", "metaDescription", "createdAt", "updatedAt") VALUES ('cmt1srtq5002quadwsj7o7qgt', 'Daxili Kredit', 'daxili-kredit', 'Seçilmiş əmlaklar üçün fərdi ilkin ödəniş və mərhələli ödəniş qrafiki ilə şirkətdaxili kredit imkanları və müqavilə dəstəyi.', 'Bəzi əmlaklar üzrə şirkət daxili ödəniş imkanları təklif olunur. Bu imkan alıcıya ödənişi mərhələlərlə həyata keçirməyə şərait yaradır.

Daxili kredit şərtləri hər bir əmlak üzrə fərdi müəyyən edilir. Konkret şərtləri öyrənmək üçün bizimlə əlaqə saxlayın.', 'Wallet', 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&w=1400&q=80', '["Əmlak üzrə fərdi ödəniş qrafiki","İlkin ödəniş variantları","Şəffaf şərtlər və razılaşma","Rəsmi müqavilə ilə rəsmiləşdirmə"]', 3, 1, 'Daxili Kredit — Luxe Home Estate', 'Şirkətin təqdim etdiyi daxili kredit imkanları.', '2026-08-20T17:31:31.517Z', '2026-08-20T17:31:31.517Z');
INSERT OR IGNORE INTO "Service" ("id", "title", "slug", "shortDescription", "description", "icon", "imageUrl", "bullets", "order", "isActive", "metaTitle", "metaDescription", "createdAt", "updatedAt") VALUES ('cmt1srtqf002ruadwk8h91k1m', 'Təmir-Tikinti', 'temir-tikinti', 'Bakıda mənzil və kommersiya obyektləri üçün kosmetik və əsaslı təmir, tikinti, daxili dizayn, smeta və mərhələli təhvil xidmətləri.', 'Aldığınız və ya mövcud əmlakınızın təmir və tikinti işlərini təşkil edirik. Kosmetik təmirdən başlayaraq tam yenidənqurma və daxili dizayn işlərinə qədər müxtəlif həcmli layihələr üzrə xidmət göstərilir.

İş başlamazdan əvvəl smeta hazırlanır, mərhələlər və müddət razılaşdırılır.', 'Hammer', 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&w=1400&q=80', '["Kosmetik və əsaslı təmir","Daxili dizayn və planlaşdırma","Smeta və iş qrafikinin hazırlanması","Material seçimində dəstək","İşin mərhələli təhvili"]', 4, 1, 'Təmir-Tikinti — Luxe Home Estate', 'Əmlakların təmir və tikinti işlərinin həyata keçirilməsi.', '2026-08-20T17:31:31.527Z', '2026-08-20T17:31:31.527Z');
INSERT OR IGNORE INTO "Service" ("id", "title", "slug", "shortDescription", "description", "icon", "imageUrl", "bullets", "order", "isActive", "metaTitle", "metaDescription", "createdAt", "updatedAt") VALUES ('cmt1srtqr002suadw6ffc8lyf', 'Reklam', 'reklam', 'Əmlak elanının hazırlanması, peşəkar təqdimatı, sosial media yayımı və hədəflənmiş rəqəmsal reklam kampaniyaları üzrə xidmət.', 'Əmlakınızın daha geniş auditoriyaya çatması üçün tanıtım xidmətləri təqdim edirik. Elanın hazırlanması, sosial media və rəqəmsal platformalarda yerləşdirilməsi, hədəflənmiş reklam kampaniyalarının qurulması bu xidmətə daxildir.

Məqsəd əmlakın düzgün auditoriyaya, düzgün formatda təqdim edilməsidir.', 'Megaphone', 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&fit=crop&w=1400&q=80', '["Elan mətninin peşəkar hazırlanması","Sosial media tanıtımı","Hədəflənmiş rəqəmsal reklam","Luxe Home Estate platformasında yerləşdirmə","Nəticələr üzrə hesabat"]', 5, 1, 'Reklam — Luxe Home Estate', 'Daşınmaz əmlakların tanıtımı və reklam xidmətləri.', '2026-08-20T17:31:31.539Z', '2026-08-20T17:31:31.539Z');
INSERT OR IGNORE INTO "Service" ("id", "title", "slug", "shortDescription", "description", "icon", "imageUrl", "bullets", "order", "isActive", "metaTitle", "metaDescription", "createdAt", "updatedAt") VALUES ('cmt1srtr3002tuadwh0ts429k', 'Çəkiliş', 'cekilis', 'Əmlaklar üçün peşəkar interyer və eksteryer fotoçəkilişi, video təqdimat, dron çəkilişi, 360° panorama və şəkil emalı.', 'Daşınmaz əmlakın satış sürətini ən çox təsir edən amillərdən biri keyfiyyətli vizual materialdır. Peşəkar foto və video çəkiliş, dron çəkilişi və 360° panoram materiallarının hazırlanması üzrə xidmət göstəririk.

Hər çəkiliş əmlakın güclü tərəflərini önə çıxaracaq şəkildə planlaşdırılır.', 'Camera', 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=1400&q=80', '["Peşəkar interyer və eksteryer fotoçəkilişi","Video təqdimat rolikləri","Dron ilə hava çəkilişi","Şəkillərin peşəkar emalı","Sosial media üçün format hazırlığı"]', 6, 1, 'Çəkiliş — Luxe Home Estate', 'Professional foto və video çəkiliş xidmətləri.', '2026-08-20T17:31:31.551Z', '2026-08-20T17:31:31.551Z');
