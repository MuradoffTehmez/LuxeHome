...
UPDATE "KnowledgeArticle" SET "status"='PUBLISHED', "legalReviewedAt"='2026-08-30T00:00:00.000Z', "updatedAt"=CURRENT_TIMESTAMP WHERE "id" LIKE 'knowledge_article_%';
INSERT INTO "KnowledgeTerm" ("id","slug","term","searchName","shortDefinition","definition","initial","categoryId","status","order","createdAt","updatedAt") VALUES ('knowledge_term_cixaris-kupca','cixaris-kupca','Çıxarış (kupça)','cixaris kupca','Əmlak üzərində mülkiyyət hüququnun dövlət reyestrində qeydiyyata alındığını təsdiqləyən rəsmi sənəd.','<p>Əmlak üzərində mülkiyyət hüququnun dövlət reyestrində qeydiyyata alındığını təsdiqləyən rəsmi sənəd.</p>','Ç',(SELECT "id" FROM "KnowledgeCategory" WHERE "slug"='qeydiyyat-notariat'),'PUBLISHED',0,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "term"=excluded."term","searchName"=excluded."searchName","shortDefinition"=excluded."shortDefinition","definition"=excluded."definition","initial"=excluded."initial","categoryId"=excluded."categoryId","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeTerm" ("id","slug","term","searchName","shortDefinition","definition","initial","categoryId","status","order","createdAt","updatedAt") VALUES ('knowledge_term_payli-mulkiyyet','payli-mulkiyyet','Paylı mülkiyyət','payli mulkiyyet','Bir əmlakda hər bir mülkiyyətçinin payının faiz və ya kəsr şəklində əvvəlcədən müəyyən edildiyi mülkiyyət forması.','<p>Bir əmlakda hər bir mülkiyyətçinin payının faiz və ya kəsr şəklində əvvəlcədən müəyyən edildiyi mülkiyyət forması.</p>','P',(SELECT "id" FROM "KnowledgeCategory" WHERE "slug"='alqi-satqi'),'PUBLISHED',10,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "term"=excluded."term","searchName"=excluded."searchName","shortDefinition"=excluded."shortDefinition","definition"=excluded."definition","initial"=excluded."initial","categoryId"=excluded."categoryId","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeTerm" ("id","slug","term","searchName","shortDefinition","definition","initial","categoryId","status","order","createdAt","updatedAt") VALUES ('knowledge_term_birge-mulkiyyet','birge-mulkiyyet','Birgə mülkiyyət','birge mulkiyyet','Paylar əvvəlcədən müəyyən edilmədən əmlakın bir neçə şəxsə, adətən ər-arvada, birlikdə məxsus olması.','<p>Paylar əvvəlcədən müəyyən edilmədən əmlakın bir neçə şəxsə, adətən ər-arvada, birlikdə məxsus olması.</p>','B',(SELECT "id" FROM "KnowledgeCategory" WHERE "slug"='alqi-satqi'),'PUBLISHED',20,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "term"=excluded."term","searchName"=excluded."searchName","shortDefinition"=excluded."shortDefinition","definition"=excluded."definition","initial"=excluded."initial","categoryId"=excluded."categoryId","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeTerm" ("id","slug","term","searchName","shortDefinition","definition","initial","categoryId","status","order","createdAt","updatedAt") VALUES ('knowledge_term_ipoteka','ipoteka','İpoteka','ipoteka','Borclunun öhdəliyinə təminat kimi daşınmaz əmlakın kreditorun xeyrinə yüklü edilməsi.','<p>Borclunun öhdəliyinə təminat kimi daşınmaz əmlakın kreditorun xeyrinə yüklü edilməsi.</p>','İ',(SELECT "id" FROM "KnowledgeCategory" WHERE "slug"='ipoteka-maliyye'),'PUBLISHED',30,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "term"=excluded."term","searchName"=excluded."searchName","shortDefinition"=excluded."shortDefinition","definition"=excluded."definition","initial"=excluded."initial","categoryId"=excluded."categoryId","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeTerm" ("id","slug","term","searchName","shortDefinition","definition","initial","categoryId","status","order","createdAt","updatedAt") VALUES ('knowledge_term_beh','beh','Beh','beh','Müqavilənin bağlandığını təsdiqləyən və icrasını təmin edən qabaqcadan ödəniş; avansla eyni hüquqi nəticəni daşımır.','<p>Müqavilənin bağlandığını təsdiqləyən və icrasını təmin edən qabaqcadan ödəniş; avansla eyni hüquqi nəticəni daşımır.</p>','B',(SELECT "id" FROM "KnowledgeCategory" WHERE "slug"='alqi-satqi'),'PUBLISHED',40,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "term"=excluded."term","searchName"=excluded."searchName","shortDefinition"=excluded."shortDefinition","definition"=excluded."definition","initial"=excluded."initial","categoryId"=excluded."categoryId","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeTerm" ("id","slug","term","searchName","shortDefinition","definition","initial","categoryId","status","order","createdAt","updatedAt") VALUES ('knowledge_term_vindikasiya-iddiasi','vindikasiya-iddiasi','Vindikasiya iddiası','vindikasiya iddiasi','Mülkiyyətçinin əmlakını başqasının qanunsuz sahibliyindən geri tələb etməsi barədə iddia.','<p>Mülkiyyətçinin əmlakını başqasının qanunsuz sahibliyindən geri tələb etməsi barədə iddia.</p>','V',(SELECT "id" FROM "KnowledgeCategory" WHERE "slug"='mehkemeler'),'PUBLISHED',50,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "term"=excluded."term","searchName"=excluded."searchName","shortDefinition"=excluded."shortDefinition","definition"=excluded."definition","initial"=excluded."initial","categoryId"=excluded."categoryId","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeTerm" ("id","slug","term","searchName","shortDefinition","definition","initial","categoryId","status","order","createdAt","updatedAt") VALUES ('knowledge_term_neqator-iddia','neqator-iddia','Neqator iddia','neqator iddia','Mülkiyyətçinin sahiblikdən məhrum edilmədən əmlakdan istifadəsinə yaradılan maneələrin aradan qaldırılması tələbi.','<p>Mülkiyyətçinin sahiblikdən məhrum edilmədən əmlakdan istifadəsinə yaradılan maneələrin aradan qaldırılması tələbi.</p>','N',(SELECT "id" FROM "KnowledgeCategory" WHERE "slug"='mehkemeler'),'PUBLISHED',60,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "term"=excluded."term","searchName"=excluded."searchName","shortDefinition"=excluded."shortDefinition","definition"=excluded."definition","initial"=excluded."initial","categoryId"=excluded."categoryId","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeTerm" ("id","slug","term","searchName","shortDefinition","definition","initial","categoryId","status","order","createdAt","updatedAt") VALUES ('knowledge_term_torpagin-teyinati','torpagin-teyinati','Torpağın təyinatı','torpagin teyinati','Torpaq sahəsindən hansı məqsədlə istifadə oluna biləcəyini müəyyən edən hüquqi kateqoriya və istifadə rejimi.','<p>Torpaq sahəsindən hansı məqsədlə istifadə oluna biləcəyini müəyyən edən hüquqi kateqoriya və istifadə rejimi.</p>','T',(SELECT "id" FROM "KnowledgeCategory" WHERE "slug"='torpaq'),'PUBLISHED',70,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "term"=excluded."term","searchName"=excluded."searchName","shortDefinition"=excluded."shortDefinition","definition"=excluded."definition","initial"=excluded."initial","categoryId"=excluded."categoryId","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeTerm" ("id","slug","term","searchName","shortDefinition","definition","initial","categoryId","status","order","createdAt","updatedAt") VALUES ('knowledge_term_agent','agent','Agent','agent','Müştərinin marağında əmlakın tapılması, təqdimatı, danışıqlar və əməliyyat koordinasiyasını həyata keçirən şəxs.','<p>Müştərinin marağında əmlakın tapılması, təqdimatı, danışıqlar və əməliyyat koordinasiyasını həyata keçirən şəxs.</p>','A',(SELECT "id" FROM "KnowledgeCategory" WHERE "slug"='agentlik-brokerlik'),'PUBLISHED',80,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "term"=excluded."term","searchName"=excluded."searchName","shortDefinition"=excluded."shortDefinition","definition"=excluded."definition","initial"=excluded."initial","categoryId"=excluded."categoryId","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeTerm" ("id","slug","term","searchName","shortDefinition","definition","initial","categoryId","status","order","createdAt","updatedAt") VALUES ('knowledge_term_broker','broker','Broker','broker','Müqavilənin bağlanmasına brokerlik müqaviləsi çərçivəsində vasitəçilik edən şəxs.','<p>Müqavilənin bağlanmasına brokerlik müqaviləsi çərçivəsində vasitəçilik edən şəxs.</p>','B',(SELECT "id" FROM "KnowledgeCategory" WHERE "slug"='agentlik-brokerlik'),'PUBLISHED',90,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "term"=excluded."term","searchName"=excluded."searchName","shortDefinition"=excluded."shortDefinition","definition"=excluded."definition","initial"=excluded."initial","categoryId"=excluded."categoryId","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeTerm" ("id","slug","term","searchName","shortDefinition","definition","initial","categoryId","status","order","createdAt","updatedAt") VALUES ('knowledge_term_numayende','numayende','Nümayəndə','numayende','Etibarnamə və ya başqa qanuni əsasla şəxsin adından hüquqi hərəkət etmək səlahiyyəti olan şəxs.','<p>Etibarnamə və ya başqa qanuni əsasla şəxsin adından hüquqi hərəkət etmək səlahiyyəti olan şəxs.</p>','N',(SELECT "id" FROM "KnowledgeCategory" WHERE "slug"='agentlik-brokerlik'),'PUBLISHED',100,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "term"=excluded."term","searchName"=excluded."searchName","shortDefinition"=excluded."shortDefinition","definition"=excluded."definition","initial"=excluded."initial","categoryId"=excluded."categoryId","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeTerm" ("id","slug","term","searchName","shortDefinition","definition","initial","categoryId","status","order","createdAt","updatedAt") VALUES ('knowledge_term_ilkin-muqavile','ilkin-muqavile','İlkin müqavilə','ilkin muqavile','Tərəflərin gələcəkdə əsas müqaviləni bağlamaq öhdəliyini müəyyən edən, lakin özü mülkiyyət hüququ yaratmayan müqavilə.','<p>Tərəflərin gələcəkdə əsas müqaviləni bağlamaq öhdəliyini müəyyən edən, lakin özü mülkiyyət hüququ yaratmayan müqavilə.</p>','İ',(SELECT "id" FROM "KnowledgeCategory" WHERE "slug"='yeni-tikili'),'PUBLISHED',110,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "term"=excluded."term","searchName"=excluded."searchName","shortDefinition"=excluded."shortDefinition","definition"=excluded."definition","initial"=excluded."initial","categoryId"=excluded."categoryId","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeFaq" ("id","question","answer","category","status","order","createdAt","updatedAt") VALUES ('knowledge_faq_cixaris-olmadan-notarial-menzil-satisi-mumkundurmu','Çıxarış olmadan notarial mənzil satışı mümkündürmü?','<p>Dövlət reyestrində qeydiyyat tələb olunan daşınmaz əmlakın adi alqı-satqısı üçün mülkiyyət hüququnun qeydiyyatı əsas şərtdir.</p>','PURCHASE','PUBLISHED',0,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "question"=excluded."question","answer"=excluded."answer","category"=excluded."category","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeFaq" ("id","question","answer","category","status","order","createdAt","updatedAt") VALUES ('knowledge_faq_kupcasi-olmayan-yalniz-mtk-muqavilesi-olan-evi-ipoteka-ile-almaq-mumkundurmu','Kupçası olmayan, yalnız MTK müqaviləsi olan evi ipoteka ilə almaq mümkündürmü?','<p>Adətən xeyr. Bank ipotekası üçün alınan yaşayış sahəsi üzərində mülkiyyət hüququ dövlət qeydiyyatında olmalı və əmlak ipoteka predmeti kimi qəbul edilməlidir.</p>','PAYMENT','PUBLISHED',10,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "question"=excluded."question","answer"=excluded."answer","category"=excluded."category","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeFaq" ("id","question","answer","category","status","order","createdAt","updatedAt") VALUES ('knowledge_faq_menzil-satilarken-mtk-nin-sened-deyisikliyi-ucun-elave-faiz-teleb-etmesi-qanunidirmi','Mənzil satılarkən MTK-nın sənəd dəyişikliyi üçün əlavə faiz tələb etməsi qanunidirmi?','<p>Ümumi qanunvericilikdə MTK üçün satış qiymətindən məcburi faiz nəzərdə tutulmur. Tələb olunan hər ödənişin hüquqi və müqavilə əsası yazılı şəkildə göstərilməlidir.</p>','LEGAL','PUBLISHED',20,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "question"=excluded."question","answer"=excluded."answer","category"=excluded."category","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeFaq" ("id","question","answer","category","status","order","createdAt","updatedAt") VALUES ('knowledge_faq_emlak-kirayeye-verilende-vergini-kim-odeyir','Əmlak kirayəyə veriləndə vergini kim ödəyir?','<p>Ödəmə mexanizmi kirayəçinin vergi statusundan asılıdır. Hüquqi şəxs ödəmə mənbəyində vergi tuta bilər; fiziki şəxsə kirayədə isə ev sahibinin uçot və bəyannamə öhdəliyi yarana bilər.</p>','RENT','PUBLISHED',30,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "question"=excluded."question","answer"=excluded."answer","category"=excluded."category","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeFaq" ("id","question","answer","category","status","order","createdAt","updatedAt") VALUES ('knowledge_faq_dasinmaz-emlakin-icbari-sigortasi-mecburidirmi','Daşınmaz əmlakın icbari sığortası məcburidirmi?','<p>Qanunda nəzərdə tutulan daşınmaz əmlak üçün icbari sığorta tələb olunur. Məbləğ və məsuliyyət əmlakın yerləşdiyi əraziyə və şəxsin statusuna görə dəyişir.</p>','LEGAL','PUBLISHED',40,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "question"=excluded."question","answer"=excluded."answer","category"=excluded."category","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeFaq" ("id","question","answer","category","status","order","createdAt","updatedAt") VALUES ('knowledge_faq_binanin-idareetmesini-mtk-dan-sakinlerin-idareetmesine-kecirmek-mumkundurmu','Binanın idarəetməsini MTK-dan sakinlərin idarəetməsinə keçirmək mümkündürmü?','<p>Mənzil mülkiyyətçiləri qanunda nəzərdə tutulan ümumi yığıncaq və səs çoxluğu qaydalarına əməl etməklə müştərək idarəetmə qurumu yarada bilərlər.</p>','LEGAL','PUBLISHED',50,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "question"=excluded."question","answer"=excluded."answer","category"=excluded."category","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeFaq" ("id","question","answer","category","status","order","createdAt","updatedAt") VALUES ('knowledge_faq_alti-ay-kecdikde-miras-huququ-avtomatik-itirilirmi','Altı ay keçdikdə miras hüququ avtomatik itirilirmi?','<p>Xeyr. Bu mövzuda köhnə internet izahlarına güvənmək olmaz; 2023-cü il Konstitusiya Məhkəməsi qərarının nəticələri və konkret vərəsəlik faktları ayrıca qiymətləndirilməlidir.</p>','LEGAL','PUBLISHED',60,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "question"=excluded."question","answer"=excluded."answer","category"=excluded."category","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeFaq" ("id","question","answer","category","status","order","createdAt","updatedAt") VALUES ('knowledge_faq_agent-komissiyani-yalniz-sifahi-razilasma-esasinda-teleb-ede-bilermi','Agent komissiyanı yalnız şifahi razılaşma əsasında tələb edə bilərmi?','<p>Faktiki münasibətin sübutundan asılı olaraq mübahisə yarana bilər, lakin komissiya, yaranma anı və xidmət həcmi yazılı broker və ya agentlik müqaviləsində göstərilməlidir.</p>','AGENCY','PUBLISHED',70,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "question"=excluded."question","answer"=excluded."answer","category"=excluded."category","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeFaq" ("id","question","answer","category","status","order","createdAt","updatedAt") VALUES ('knowledge_faq_agent-saticinin-adindan-muqavile-imzalaya-bilermi','Agent satıcının adından müqavilə imzalaya bilərmi?','<p>Yalnız qanuni nümayəndəlik səlahiyyəti, məsələn etibarlı etibarnamə varsa. Agentlik xidməti öz-özünə müştərinin adından əqd bağlamaq hüququ vermir.</p>','AGENCY','PUBLISHED',80,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "question"=excluded."question","answer"=excluded."answer","category"=excluded."category","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
INSERT INTO "KnowledgeFaq" ("id","question","answer","category","status","order","createdAt","updatedAt") VALUES ('knowledge_faq_dasinmaz-emlak-agenti-ucun-2-faiz-mecburi-komissiyadirmi','Daşınmaz əmlak agenti üçün 2 faiz məcburi komissiyadırmı?','<p>Xeyr. Ümumi daşınmaz əmlak əməliyyatları üçün qanuni sabit 2 faiz komissiya norması yoxdur; haqq və ödəniş şərtləri müqavilədə müəyyən edilir.</p>','AGENCY','PUBLISHED',90,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ON CONFLICT("id") DO UPDATE SET "question"=excluded."question","answer"=excluded."answer","category"=excluded."category","status"='PUBLISHED',"order"=excluded."order","updatedAt"=CURRENT_TIMESTAMP;
