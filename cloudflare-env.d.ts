/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 644f787ab73f9059e328912d9e09a911)
// Runtime types generated with workerd@1.20260908.1 2026-08-20 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	IS_STAGING?: "true";
	SITE_URL: "https://luxehomeestate-staging.amiyevbahadur.workers.dev" | "https://luxehomeestate.az";
	GSC_SITE_URL: "sc-domain:luxehomeestate.az";
	TURNSTILE_SITE_KEY: "0x4AAAAAAEfhXUNNmS0Ka_DO";
	TURNSTILE_HOSTNAMES: "luxehomeestate-staging.amiyevbahadur.workers.dev" | "luxehomeestate.az,www.luxehomeestate.az";
	CF_ZONE_ID: "d401a9f612bc47ed88e1c14e658141d1";
	CF_ACCOUNT_ID: "8e6ae175474aa8e5033b3b9087775250";
	NEXTJS_ENV: string;
	CRON_SECRET: string;
	WORKER_SELF_REFERENCE: Fetcher /* luxehomeestate-staging */ | Service<typeof import("./.open-next/worker").default>;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		NEXTJS_ENV: string;
		CRON_SECRET: string;
		WORKER_SELF_REFERENCE: Fetcher /* luxehomeestate-staging */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_ENABLED" | "SYSTEM_MODE" | "FORCE_MAINTENANCE" | "IS_STAGING" | "SITE_URL" | "GSC_SITE_URL" | "TURNSTILE_SITE_KEY" | "TURNSTILE_HOSTNAMES" | "CF_ZONE_ID" | "CF_ACCOUNT_ID" | "NEXTJS_ENV" | "CRON_SECRET">> {}
}
